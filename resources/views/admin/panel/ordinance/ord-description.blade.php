...
@section('adminpanel-content')
    ...
    $lightboxIndex = 0; // We'll use this to keep track of which image is which
                        ...
                        <div class="ordinance-document mb-4 mb-md-5 p-3 p-md-5 shadow-soft rounded bg-white">
                            ...
                            <div class="position-relative d-flex flex-wrap gap-2 mb-3 p-2" style="z-index: 10;">
                                ...
                                <form action="{{ route('ord-delete', $ordinance->id) }}" method="POST" class="d-inline"
                                    onsubmit="return confirm('Are you sure you want to delete this ordinance?');">
                                    @csrf
                                    @method('DELETE')

                                    {{-- Sneak the UID in here! --}}
            ...
            <div class="modal fade" id="imageLightbox" tabindex="-1" aria-hidden="true">
                ...
                {{-- 3. NEW: Prev and Next Navigation Buttons (Hidden by default) --}}
            ...
            <script>
                // 4. Pass our PHP array of images to JavaScript
                const galleryImages = @json($imageAttachments);
                ...
                function navigateLightbox(direction) {
                    // Add direction (-1 or 1)
                    currentImageIndex += direction;

                    // Loop around if we go past the start or end
                    if (currentImageIndex < 0) {
                        currentImageIndex = galleryImages.length - 1; // Go to last image
                ...
                function updateLightboxView() {
                    ...
                    // Only show Prev/Next buttons if there are 2 or more images!
            ...
            <style>
                ...
                /* --- Z-INDEX FIX FOR NAVBAR COLLISION --- */
                .modal {
                    z-index: 10000 !important; /* Forces modal above the navbar */
                }

                .modal-backdrop.show {
                    opacity: 0.9 !important;
                    background-color: #000 !important;
                    z-index: 9999 !important; /* Forces backdrop above the navbar */
                }

                /* Ensures your close and navigation buttons are always clickable */
