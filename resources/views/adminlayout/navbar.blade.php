...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        ...
        <button class="navbar-toggler position-absolute top-0 end-0" type="button" data-bs-toggle="collapse" data-bs-target="#adminNavbar"
        ...
        <div class="d-none d-lg-flex w-100">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                @else
                    <li class="nav-item">
                        <span class="nav-link text-dark navigation">Hello, {{ auth()->user()->name }}</span>
                    </li>
                    <li class="nav-item">
...
<div class="collapse bg-light w-100" id="adminNavbar">
    <div class="container-fluid ps-0">
        <ul class="navbar-nav py-2 ps-3 text-start w-100">
            @guest
                <li class="nav-item">
                    <a class="nav-link text-dark navigation" href="login"><strong>LOGIN</strong></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-dark navigation" href="signup"><strong>SIGN UP</strong></a>
                </li>
            @else
                <li class="nav-item">
                    <span class="nav-link text-dark navigation">Hello, {{ auth()->user()->name }}</span>
