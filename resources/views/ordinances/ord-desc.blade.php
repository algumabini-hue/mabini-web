                            ...
                            <div class="ordinance-content">
                                ...
                                @if(!empty($ordinance->subject))
                                    <div class="mb-5">
                                        ...
                                        {{-- CRITICAL FIX: Added 'ps-3' here so it has a gap on mobile! --}}
                                        <p class="ordinance-title text-uppercase ps-3 ps-md-4 mb-0 fw-bold fs-5" style="border-left: 4px solid #198754;">
